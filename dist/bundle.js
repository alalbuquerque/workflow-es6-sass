...
var Keyboard = {
  ...
  handleKey(event, component, functions) {
    ...
    if (typeof commandList.ltr === 'undefined') { // this component does not differentiate between ltr and rtl
        ...
        if (Object(__WEBPACK_IMPORTED_MODULE_1__foundation_util_core__["rtl"])()) cmds = __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.extend({}, commandList.ltr, commandList.rtl);
...
var _foundation_custom = _interopRequireDefault(__webpack_require__(7));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var message = 'this is home';

var foo = function foo() {
  console.log(message, _foundation_custom.default);
};
...
var _foundationUtil6 = __webpack_require__(3);
...
_foundation.Foundation.Timer = _foundationUtil8.Timer; // Touch and Triggers previously were almost purely sede effect driven,
// so no // need to add it to Foundation, just init them.

_foundationUtil9.Touch.init(_jquery.default);

_foundationUtil10.Triggers.init(_jquery.default, _foundation.Foundation); // import { Abide } from 'foundation-sites/js/foundation.abide';
...
_foundation.Foundation.plugin(_foundation2.Reveal, 'Reveal'); // import { Slider } from 'foundation-sites/js/foundation.slider';
...
function GetOffsets(element, anchor, position, vOffset, hOffset, isOverflow) {
  ...
  switch (position) {
    case 'top':
      return Object(__WEBPACK_IMPORTED_MODULE_0__foundation_util_core__["rtl"])() ?
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__foundation_plugin__ = __webpack_require__(15);
